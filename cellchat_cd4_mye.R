...
mysce.t <- readRDS("cd4_labeled.rds")
...
saveRDS(mysce.merge, file = 'cellchat_cd4_mye.rds')
...
write.table(df.net, file = 'net_lr_cd4_mye.csv', sep = ',')

#Infer the cell-cell communication at a signaling pathway level
cellchat <- computeCommunProbPathway(cellchat)
df.netp <- subsetCommunication(cellchat, slot.name = 'netP')
write.table(df.netp, file = 'net_pathway_cd4_mye.csv')
