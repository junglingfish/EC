...
pdf("cd8.pseudotime_modi.pdf",width = 10,height = 7)
plot_cell_trajectory(cds, color_by="Pseudotime", size=1, show_tree = TRUE, show_backbone=TRUE) 
dev.off()

pdf("cd8.state_modi.pdf",width = 10,height = 7)
plot_cell_trajectory(cds, color_by="State", size=1, show_tree = TRUE, show_backbone=TRUE) 
dev.off()

pdf("cd8.celltype_modi.pdf",width = 10,height = 7)
plot_cell_trajectory(cds, color_by=Idents(cd8), size=1, show_tree = TRUE, show_backbone=TRUE) 
dev.off()
